...
public partial class CoreWebView2CreationProperties : AvaloniaObject
{
    ...
    {
        BrowserExecutableFolderProperty.Changed.AddClassHandler<
            CoreWebView2CreationProperties,
            string
        >(
            (t, args) =>
            {
                EnvironmentPropertyChanged(args);
            }
        );
        UserDataFolderProperty.Changed.AddClassHandler<CoreWebView2CreationProperties, string>(
            (t, args) =>
            {
                EnvironmentPropertyChanged(args);
            }
        );
        LanguageProperty.Changed.AddClassHandler<CoreWebView2CreationProperties, string>(
            (t, args) =>
            {
                EnvironmentPropertyChanged(args);
            }
    ...
    public static readonly StyledProperty<string> BrowserExecutableFolderProperty =
        AvaloniaProperty.Register<CoreWebView2CreationProperties, string>(
    ...
    public static readonly StyledProperty<string> UserDataFolderProperty =
        AvaloniaProperty.Register<CoreWebView2CreationProperties, string>(nameof(UserDataFolder));
    ...
    /// </summary>
    public static readonly StyledProperty<string> ProfileNameProperty = AvaloniaProperty.Register<
        CoreWebView2CreationProperties,
        string
    >(nameof(ProfileName));
    ...
    public static readonly StyledProperty<bool?> IsInPrivateModeEnabledProperty =
        AvaloniaProperty.Register<CoreWebView2CreationProperties, bool?>(
            nameof(IsInPrivateModeEnabled)
        );

    /// <summary>
    /// The AvaloniaProperty which backs the <see cref="EnabledDevTools" /> property.
    /// </summary>
    public static readonly StyledProperty<bool> EnabledDevToolsProperty = AvaloniaProperty.Register<
        CoreWebView2CreationProperties,
        bool
    >(nameof(EnabledDevTools));
            ...
            if (_task == null)
            {
                if (BrowserExecutableFolder != null || UserDataFolder != null || Language != null)
                    _task = CoreWebView2Environment.CreateAsync(
                        ...
                        UserDataFolder,
                        new CoreWebView2EnvironmentOptions(language: Language)
                    );
                else
                    _task = CoreWebView2Environment.CreateAsync();
            }
    ...
    public virtual CoreWebView2ControllerOptions? CreateCoreWebView2ControllerOptions(
