...
partial class WebView2
{
    ...
    /// </summary>
    public static readonly DirectProperty<WebView2, bool> CanGoForwardProperty =
        AvaloniaProperty.RegisterDirect<WebView2, bool>(nameof(CanGoForward), x => x.CanGoForward);
