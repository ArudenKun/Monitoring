...
partial class WebView2
{
    ...
    )
    {
        ...
        {
            if (
                (!_isExplicitEnvironment && environment != null)
                || (_isExplicitEnvironment && environment != null && this.env != environment)
            )
            {
            ...
            if (
                (!_isExplicitControllerOptions && controllerOptions != null)
                || (
                    _isExplicitControllerOptions
    ...
    async Task InitCoreWebView2Async(
        CoreWebView2Environment? environment = null,
        CoreWebView2ControllerOptions? controllerOptions = null
    )
    {
        ...
        try
        {
            ...
            {
                sender.opt = sender.CreationProperties.CreateCoreWebView2ControllerOptions(
                    sender.env
                );
            }
            if (sender._defaultBackgroundColor != _defaultBackgroundColorDefaultValue)
            {
                global::System.Environment.SetEnvironmentVariable(
                    ...
                    global::System
                        .Drawing.Color.FromArgb(sender.DefaultBackgroundColor.ToArgb())
                        .Name
                );
            }
            ...
            if (sender.opt != null)
            {
                CoreWebView2Controller view2ControllerAsync =
                    await sender.env.CreateCoreWebView2ControllerAsync(hwnd, sender.opt);
                sender._coreWebView2Controller = view2ControllerAsync;
            }
            else
            {
                CoreWebView2Controller view2ControllerAsync =
                    await sender.env.CreateCoreWebView2ControllerAsync(hwnd);
                sender._coreWebView2Controller = view2ControllerAsync;
            }
            ...
            sender._coreWebView2Controller.CoreWebView2.AddWebResourceRequestedFilter(
                "*",
            ...
            sender._coreWebView2Controller.CoreWebView2.Settings.AreDevToolsEnabled =
                sender.CreationProperties?.EnabledDevTools ?? false;
            sender.CoreWebView2InitializationCompleted?.Invoke(
                sender,
        ...
        catch (Exception ex)
        {
            sender.CoreWebView2InitializationCompleted?.Invoke(
                sender,
                new CoreWebView2InitializationCompletedEventArgs(ex)
            );
            throw;
        }
    }
