...
partial class WebView2
{
    ...
    void CoreWebView2_NavigationCompleted(
        object? sender,
    ...
    void CoreWebView2_WebResourceRequested(
        object? sender,
    ...
    void CoreWebView2_ContentLoading(object? sender, CoreWebView2ContentLoadingEventArgs e)
    {
        ...
        finally
        {
            if (
                !e.IsErrorPage
                && dictNavigationStarting.TryGetValue(e.NavigationId, out var requestUri)
            )
            {
    ...
    void CoreWebView2_NewWindowRequested(
        object? sender,
            ...
            if (sender is CoreWebView2 coreWebView2)
            {
                ...
                webView2.DocumentTitleChanged += async (s, e) =>
                {
                    ...
                    window.Icon = new WindowIcon(
                        await webView2.CoreWebView2!.GetFaviconAsync(
