...
{
    public WebView2KeyEventArgs(int virtualKey)
        : this(KeyInterop.KeyFromVirtualKey(virtualKey)) { }

    public WebView2KeyEventArgs(uint virtualKey)
        : this(unchecked((int)virtualKey)) { }
